...
func (uc *UserCreate) SetProviderName(s string) *UserCreate {
	uc.mutation.SetProviderName(s)
	return uc
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.ProviderName(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
